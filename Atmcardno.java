...
/*
load register driver: Class.forName("com.mysql.jdbc.Driver"); 
Connection con=DriverManager.getConnection("","","");
Statement st=con.create.Statement();
st.executeUpdate("insert into tab_name values(1,2,4,5);");
	    ...
	    try
	     {
		    ...
		    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/atmdb","root","Root@1234");
